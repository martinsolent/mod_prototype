...
export function PeerReviewML({ onNavigate, assessmentData, updateAssessmentData }: PeerReviewMLProps) {
  ...
  // Dropdown options for Module Leader and Internal Peer Reviewer
  const moduleLeaders = [
  ...
  const handleSendToPeerReview = () => {
    ...
    alert('Peer Review form has been sent to the Internal Peer Reviewer. They will be notified by email.');
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-6 rounded">
          <p className="text-sm text-blue-800">
            <strong>Module Leader:</strong> Complete this form before sending to the Internal Peer Reviewer. 
            Check the assessment components that have been confirmed, and add any comments for the reviewer. 
            You can save your progress as a draft or send directly to the peer reviewer for sign-off.
          </p>
        </div>

        <div className="bg-white border border-gray-300 rounded p-8">
          <h1 className="text-center text-2xl mb-8">Assessment Brief Peer Review - Module Leader</h1>
          ...
          <div className="grid grid-cols-[200px_1fr] gap-4 mb-6">
            ...
            <select
              ...
              onChange={(e) => handleFormChange('internalPeerReviewer', e.target.value)}
            ...
            <div className="grid grid-cols-[180px_1fr]">
              ...
              <div className="px-4 py-3">
                <textarea
                  ...
                  placeholder="Add any notes or instructions for the peer reviewer..."
                />
              </div>
            </div>
          </div>

          {/* Module Leader Actions Section */}
          <div className="border-t-2 border-gray-300 pt-6">
            <div className="bg-blue-50 border border-blue-200 rounded p-6 mb-6">
              <p className="text-sm mb-4">
                <strong>Note:</strong> Review the assessment components and confirm each item that has been completed. 
                You can save this form as a draft to continue editing later, or send it directly to the Internal Peer Reviewer for sign-off. 
                The peer reviewer will be notified by email and will review your confirmations before signing off on the assessment brief.
              </p>
            </div>
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                onClick={handleSendToPeerReview}
      ...
      <div className="border-t border-gray-200 bg-white px-6 py-3 mt-8">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-400">/</span>
          <a href="#" className="text-[#0066cc] hover:text-[#004499]">
            Assessment Brief Peer Review - Module Leader
          </a>
        </div>
      </div>
