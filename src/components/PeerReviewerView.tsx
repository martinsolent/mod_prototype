...
export function PeerReviewerView({ onNavigate, assessmentData, updateAssessmentData }: PeerReviewerViewProps) {
  ...
  const handleSignOff = () => {
    ...
    alert('Assessment Brief has been signed off successfully!\n\nThe Module Leader has been notified by email and the brief is now ready to be published.');
  };
  ...
  const handleSendBack = () => {
    if (confirm('Are you sure you want to send this brief back to the Module Leader? They will be notified by email.')) {
      updateAssessmentData({
        peerReviewComments: comments,
        peerReviewerOverallComments: reviewerOverallComments,
        peerReviewSentBack: true,
        peerReviewSignedOff: false
      });
      alert('Brief has been sent back to the Module Leader. An email notification has been sent with your feedback.');
    }
  };
        ...
        {!assessmentData.peerReviewSignedOff && (
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-6 rounded">
            <p className="text-sm text-blue-800">
              <strong>Peer Reviewer:</strong> Review the assessment components confirmed by the Module Leader below. 
              Add comments for each component if needed, and provide your overall feedback. 
              You can either sign off the brief if everything is acceptable, or send it back to the Module Leader with your recommendations for updates.
            </p>
          </div>
        )}
          ...
          <table className="w-full border-collapse border border-black mb-6">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-black px-4 py-3 text-center bg-gray-50">
                  <input
                    type="checkbox"
          ...
          <div className="border border-black mb-6">
            <div className="grid grid-cols-[200px_1fr]">
              ...
              <div className="px-4 py-3 bg-gray-50">
                <div className="w-full min-h-[80px] px-2 py-1 overflow-auto">
          ...
          <div className="border-t-2 border-gray-300 pt-6">
            <div className="bg-blue-50 border border-blue-200 rounded p-6 mb-6">
              <p className="text-sm mb-4">
                <strong>Note:</strong> Review all assessment components and add any comments or feedback. 
                If the assessment brief is acceptable, click "Sign Off Brief" to approve it. 
                If changes are needed, click "Send Back to Module Leader" with your feedback and recommendations.
              </p>
            </div>
